...
static const uint8_t DEFAULT_INSTALLATION_ANGLE = 0;  // Installation angle always starts at 0°.
...
class LD2450Component : public Component, public uart::UARTDevice {
 ...
 public:
  ...
  void set_flip_x_axis(bool flip) { this->flip_x_axis_ = flip; };
