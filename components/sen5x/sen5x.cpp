...
namespace esphome
{
  ...
  namespace sen5x
  {
    ...
    static const uint16_t SEN6X_CMD_TEMPERATURE_ACCELERATION_PARAMETERS = 0x6100;   //--|     |     |     |     |  *  |  *  |  *  |  *  |
    static const uint16_t SEN6X_CMD_PERFORM_FORCED_CO2_RECALIBRATION = 0x6707;      //--|     |     |     |     |  *  |     |  *  |     |
    static const uint16_t SEN6X_CMD_CO2_SENSOR_AUTOMATIC_SELF_CALIBRATION = 0x6711; //--|     |     |     |     |  *  |     |  *  |     |
    ...
    void SEN5XComponent::internal_setup_(uint8_t state)
    {
      ...
      case 12:
        ...
        {
          if ((this->model_.value() == SEN50 || this->model_.value() == SEN54 ||
      ...
      case 14:
        ...
        else if (this->voc_sensor_ && (this->model_.value() == SEN50 || this->model_.value() == SEN60 || this->model_.value() == SEN63C))
        {
        ...
        else if (this->nox_sensor_ && (this->model_.value() == SEN50 || this->model_.value() == SEN60 || this->model_.value() == SEN63C))
        {
        ...
        else if (this->co2_sensor_ && (this->model_.value() == SEN50 || this->model_.value() == SEN54 ||
                                      this->model_.value() == SEN55 || this->model_.value() == SEN60 ||
                                      this->model_.value() == SEN65 || this->model_.value() == SEN68))
        {
        ...
        else if (this->co2_ambient_pressure_source_ && (this->model_.value() == SEN50 || this->model_.value() == SEN54 ||
                                                        this->model_.value() == SEN55 || this->model_.value() == SEN60 ||
                                                        this->model_.value() == SEN65 || this->model_.value() == SEN68))
        {
    ...
    void SEN5XComponent::update()
    {
      ...
      this->set_timeout(20, [this, length]()
        ...
        if (this->model_.value() == SEN54 || this->model_.value() == SEN55 ||
            this->model_.value() == SEN63C || this->model_.value() == SEN65 ||
        ...
        if (this->model_.value() == SEN54 || this->model_.value() == SEN55 ||
            this->model_.value() == SEN65 || this->model_.value() == SEN66 || 
        ...
        if (this->model_.value() == SEN55 || this->model_.value() == SEN65 ||
            this->model_.value() == SEN66 || this->model_.value() == SEN68 ) {
    ...
    {
      auto result = this->write_command(SEN6X_CMD_CO2_SENSOR_AUTOMATIC_SELF_CALIBRATION, this->co2_auto_calibrate_.value() ? 0x01 : 0x00);
      if (!result)
      {
    ...
    {
      if (this->model_.value() == SEN63C || this->model_.value() == SEN65 ||
          this->model_.value() == SEN66 || this->model_.value() == SEN68)
      {
