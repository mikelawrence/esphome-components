...
namespace esphome
{
  namespace dfrobot_c4001
  {
    ...
    void DFRobotC4001Hub::set_mode(ModeConfig value)
    {
      this->mode_ = value;
    }
    ...
    void DFRobotC4001Hub::dump_config()
    {
      ...
      ESP_LOGCONFIG(TAG, "  SW Version: %s", this->sw_version_.c_str());
      ESP_LOGCONFIG(TAG, "  HW Version: %s", this->hw_version_.c_str());
      ESP_LOGCONFIG(TAG, "  Mode: %s", this->mode_ == Mode_Presence ? "PRESENCE" : "SPEED_AND_DISTANCE");
#ifdef USE_BUTTON
